...
always: dict[str, ItemData] = {
    ...
    "Crystal Generator": ItemData(5, always_progression, "RemoteCrystalGenerator",
                                  ("CrystalGeneratorDefaultVariant", ), 0),
    ...
    "Wires": ItemData(9, always_useful, "RemoteWires",
                      ("WireDefaultVariant", "WireBridgeVariant", "WireTransmitterSenderVariant",
                       "WireTransmitterReceiverVariant"), 0),
    ...
    "Logic Gates": ItemData(16, always_useful, "RemoteLogicGates",
                            ("LogicGateAndVariant", "LogicGateOrVariant", "LogicGateIfVariant", "LogicGateXOrVariant",
                             "LogicGateNotVariant", "LogicGateCompareVariant"), 0),
    ...
    "Operator Signal Receiver": ItemData(19, always_useful, "RemoteOperatorSignalReceiver",
                                         ("WireGlobalTransmitterReceiverVariant", ), 0),
